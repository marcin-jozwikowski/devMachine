...
sudo cp ./source/amp_php5-fpm.conf /etc/apache2/conf-available/php5-fpm.conf
sudo chmod o-x /etc/apache2/conf-available/php5-fpm.conf
sudo a2enconf php5-fpm.conf

sudo cp ./source/amp_devmach.loc /etc/apache2/sites-available/devmach_loc.conf
...
sudo cp ./source/amp_info.php /var/www/devmach.loc/info.php
